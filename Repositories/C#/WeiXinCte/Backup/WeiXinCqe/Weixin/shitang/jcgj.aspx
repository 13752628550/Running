<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="jcgj.aspx.cs" Inherits="WeiXinCqe.jcgj" %>
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="DINNER_SMALL_TYPE" HeaderText="小餐别">
                        ...
                        <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                          ...
                          <asp:BoundField DataField="DINNER_COUNT" HeaderText="预约">
                        <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                        <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                    </asp:BoundField>
                          <asp:BoundField DataField="DINNER_JIU_COUNT" HeaderText="就餐">
                        <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                        <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                    </asp:BoundField>
                              <asp:BoundField DataField="TIME_GUJI" HeaderText="时间点">
                        <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                        <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                    </asp:BoundField>
                </Columns>
