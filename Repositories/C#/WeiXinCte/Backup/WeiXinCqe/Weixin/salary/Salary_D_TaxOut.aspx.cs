...
{
    public partial class Salary_D_TaxOut : System.Web.UI.Page
    {
        ...
        private void init()
        {
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    Label11.Text = "工资应税额=支付合计(C)-短期扣除=" + dt.Rows[0]["S_PAY_TAX"].ToString();
