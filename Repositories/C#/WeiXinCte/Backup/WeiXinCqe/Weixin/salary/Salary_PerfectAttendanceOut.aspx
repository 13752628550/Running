<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Salary_PerfectAttendanceOut.aspx.cs" Inherits="WeiXinCqe.Salary_PerfectAttendanceOut" %>
...
<body>
    ...
    <div class="weui_cells weui_cells_form">
        ...
        <div class="weui_cell">
            <div class="weui_cell_bd weui_cell_primary">
                <asp:Label ID="labelADJUSTMENT_PAY2" runat="server" class="weui_label" Font-Size="12pt">扣除标准:</asp:Label></div>
            <div class="weui_cell_bd weui_cell_primary">
                <strong>
