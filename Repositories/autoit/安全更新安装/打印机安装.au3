...
$Form1 = GUICreate("打印机安装", 463, 320, 420, 249)
$PageControl1 = GUICtrlCreateTab(8, 45, 444, 177)
...
;GUICtrlSetFont(-1, 8, 400, 0, "Arial")
$Radio5 = GUICtrlCreateRadio("Radio5", 48, 165, 73, 33)
;GUICtrlSetFont(-1, 8, 400, 0, "Arial")
...
;GUICtrlSetFont(-1, 8, 400, 0, "Arial")
$Radio9 = GUICtrlCreateRadio("(生技) HP LaserJet 400 M401n", 48, 125, 177, 25)
;GUICtrlSetFont(-1, 8, 400, 0, "Arial")
...
;GUICtrlSetFont(-1, 8, 400, 0, "Arial")
GUICtrlSetState(-1, $GUI_HIDE)
$TabSheet3 = GUICtrlCreateTabItem("技术中心")
$Radio13 = GUICtrlCreateRadio("Canon IR2018", 64, 93, 145, 25)
;GUICtrlSetFont(-1, 8, 400, 0, "Arial")
$Radio14 = GUICtrlCreateRadio("Canon iR-ADV 4045", 248, 90, 129, 32)
;GUICtrlSetFont(-1, 8, 400, 0, "Arial")
$Radio15 = GUICtrlCreateRadio("HP LaserJet 5100 Series", 64, 133, 177, 33)
;GUICtrlSetFont(-1, 8, 400, 0, "Arial")
$Radio16 = GUICtrlCreateRadio("Radio16", 248, 133, 129, 33)
;GUICtrlSetFont(-1, 8, 400, 0, "Arial")
GUICtrlSetState(-1, $GUI_HIDE)
...
$Radio20 = GUICtrlCreateRadio("HP DesignJet 500", 248, 85, 137, 25)
...
$Radio26 = GUICtrlCreateRadio("(资材部) Canon LBP6300", 232, 93, 161, 25)
$Radio27 = GUICtrlCreateRadio("Radio27", 80, 125, 129, 25)
GUICtrlSetState(-1, $GUI_HIDE)
$Radio28 = GUICtrlCreateRadio("Radio28", 232, 119, 145, 33)
GUICtrlSetState(-1, $GUI_HIDE)
		...
		Case $Button1
			Select
				...
				Case BitAND(GUICtrlRead($radio9), $GUI_CHECKED) = $GUI_CHECKED
					$IP = "172.26.36.248"
 					$Name = "(车载二部 生技) HP LaserJet 400 m401"
				...
				Case BitAND(GUICtrlRead($radio13), $GUI_CHECKED) = $GUI_CHECKED
					$IP = "172.26.39.242"
 					$Name = "(技术中心) Canon iR2018"
 					$Driver = "Canon iR2018 UFRII LT"
 					If $osAr == "X86" Then
 						$Path = "\\172.26.32.251\softwa\print\Driver\Canon\IR2018\x86\CNLB0U.INF"
 					Else
 						$Path = "\\172.26.32.251\softwa\print\Driver\Canon\IR2018\x64\CNLB0CA64.INF"
 					EndIf
 					_install($IP, $Name, $Path, $Driver)
				;radio14 选择打印机进行安装
				...
				Case BitAND(GUICtrlRead($radio20), $GUI_CHECKED) = $GUI_CHECKED
					$IP = "172.26.37.245"
 					$Name = "(生产技术部) HP Designjet 500"
 					$Driver = ""
 					If $osAr == "X86" Then
 						$Path = "\\172.26.32.251\softwa\print\Driver\HP\DesignJet 500\x86\dsgj500.inf"
						$driver="HP Designjet 500 42 by HP"
 					Else
 						$Path = "\\172.26.32.251\softwa\print\Driver\HP\DesignJet 500\x64\dsgj500.inf"
						$driver="HP Designjet 500 42 by HP"
 					EndIf
 					_install($IP, $Name, $Path, $Driver)
				;radio21 选择打印机进行安装
