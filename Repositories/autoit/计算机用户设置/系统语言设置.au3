...
$Group1 = GUICtrlCreateGroup("系统语言设置", 18, 14, 488, 141)
...
;语言设置选项
$strPathReg="HKLM64\SYSTEM\CurrentControlSet\Control\Nls\Language"
...
Func Computer()
	...
	RunWait(@ComSpec & " /c " & $strCommand1,"",@SW_SHOW)
EndFunc

Func Language()
	If GUICtrlRead($ComboLangan)="中文" Then
		RegWrite($strPathReg,$Keyword,"REG_SZ",$Chinese)
	ElseIf GUICtrlRead($ComboLangan)="日文" Then
		MsgBox(64,"Japanese",$Japanese)
		RegWrite($strPathReg,$Keyword,"REG_SZ",$Japanese)
	EndIf
EndFunc
