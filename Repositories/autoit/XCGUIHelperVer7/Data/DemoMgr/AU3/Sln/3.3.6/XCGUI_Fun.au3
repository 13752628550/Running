...
Func _listBox_item_i()
	Return DllStructCreate("int nUserData;int nHeight;int nSelHeight;int nState;int index;ptr rcItem;int hLayout;int Info")
EndFunc
...
EndFunc
Func _list_item_i()
	Return DllStructCreate("int index;int iSubItem;int nUserData;int nState;int rcItem;int hLayout;int Info")
EndFunc
Func _list_header_item_i()
	Return DllStructCreate("int index;int nUserData;int nState;ptr rcItem;int hLayout;int Info")
EndFunc
Func _tree_item_i()
	Return DllStructCreate("int nID;int nDepth;int nState;int nHeight;int nSelHeight;int nUserData;bool bExpand;ptr rcItem;int hLayout;int Info")
EndFunc
Func _listView_item_i()
	Return DllStructCreate("int iGroup;int iItem;int nUserData;int nState;ptr rcItem;int hLayout;int Info")
EndFunc
Func _layout_info_i()
...
Func _menu_drawItem_i()
	Return DllStructCreate("int hMenu;int hWindow;int nID;int nState;ptr rcItem;int hIcon;str Text")
EndFunc
...
Func _monthCal_item_i()
	Return DllStructCreate("int nDay;int nType;int nState;ptr rcItem")
EndFunc
;=================自定义数据类型结束=======================
...
Func CopyMemory($_pa,$_pb)
	DllCall("Kernel32.dll","none","RtlMoveMemory","ptr",DllStructGetPtr($_pa),"ptr",$_pb,"int",DllStructGetSize($_pa))
EndFunc
;=================全局API开始=======================
;~ ============================================
;~   XInitXCGUI()
...
;~ ======================================================
;~ XWnd_RegEventC($_hwnd, $_fun, $_event = 34)
;~  功能: 注册事件函数C方式,事件函数省略自身HWINDOW句柄.
;~  参数:$_hwnd    窗口句柄
;~       $_fun     事件类型
;~ 	  $_event   事件函数,(可选参数,默认为点击事件)
;~ ======================================================
Func XWnd_RegEventC($_hWnd, $_fun, $_event = 34)
	DllCall($_xcdll, "none", "XWnd_RegEventC", "hwnd", $_hWnd, "int", $_event, "ptr", DllCallbackGetPtr(DllCallbackRegister($_fun, "int", "BOOL")))
...
;~ 	  $_event   事件函数,(可选参数,默认为点击事件)
;~ ======================================================
Func XWnd_RegEventC1($_hWnd, $_fun, $_event = 34)
	DllCall($_xcdll, "none", "XWnd_RegEventC1", "hwnd", $_hWnd, "int", $_event, "ptr", DllCallbackGetPtr(DllCallbackRegister($_fun, "int", "BOOL")))
...
Func XList_SetColumnWidth($_hEle, $_width)
	DllCall($_xcdll, "none", "XList_SetColumnWidth", "hwnd", $_hEle, "int", $_width)
EndFunc   ;==>XList_SetColumnWidth

Func XList_SetColumnMinWidth($_hEle, $_width)
	DllCall($_xcdll, "none", "XList_SetColumnMinWidth", "hwnd", $_hEle, "int", $_width)
EndFunc   ;==>XList_SetColumnMinWidth

Func XList_SetColumnWidthFixed($_hEle, $_bFixed)
	DllCall($_xcdll, "none", "XList_SetColumnWidthFixed", "hwnd", $_hEle, "bool", $_bFixed)
...
Func XList_HitTest($_hEle, $_pPt, $_piItem,$_piSubItem)
	$_XList = DllCall($_xcdll, "bool", "XList_HitTest", "hwnd", $_hEle, "int", $_pPt, "int", $_piItem,"int",$_piSubItem)
	Return $_XList[0]
EndFunc
...
Func XListView_HitTest($_hEle, $_pPt, $_pOutGroup, $_pOutItem)
	$_XLv = DllCall($_xcdll, "bool", "XListView_HitTest", "hwnd", $_hEle, "int*", $_pPt, "int*", $_pOutGroup, "int*", $_pOutItem)
	Return $_XLv[0]
EndFunc   ;==>XListView_HitTest

Func XListView_HitTestOffset($_hEle, $_pPt, $_pOutGroup, $_pOutItem)
	$_XLv = DllCall($_xcdll, "bool", "XListView_HitTestOffset", "hwnd", $_hEle, "int*", $_pPt, "int*", $_pOutGroup, "int*", $_pOutItem)
	Return $_XLv[0]
EndFunc
...
Func XSView_GetLineSize($_hEle, $_pSize)
	DllCall($_xcdll, "none", "XSView_GetLineSize", "hwnd", $_hEle, "int", $_pSize)
EndFunc

Func XSView_GetPadding($_hEle, $_pPadding)
	DllCall($_xcdll, "none", "XSView_GetPadding", "hwnd", $_hEle, "int", $_pPadding)
EndFunc

Func XSView_GetViewRect($_hEle, $_pRect)
	DllCall($_xcdll, "none", "XSView_GetViewRect", "hwnd", $_hEle, "int", $_pRect)
EndFunc

Func XSView_GetTotalSize($_hEle, $_pSize)
	DllCall($_xcdll, "none", "XSView_GetTotalSize", "hwnd", $_hEle, "int", $_pSize)
EndFunc
...
Func XTree_SetItemTemplateXML($_hEle, $_pXmlFile)
	$_XTree = DllCall($_xcdll, "bool", "XTree_SetItemTemplateXML", "hwnd", $_hEle, "bool", $_pXmlFile)
	Return $_XTree[0]
EndFunc   ;==>XTree_SetItemTemplateXML

Func XTree_SetItemTemplateXMLSel($_hEle, $_pXmlFile)
	$_XTree = DllCall($_xcdll, "bool", "XTree_SetItemTemplateXMLSel", "hwnd", $_hEle, "bool", $_pXmlFile)
	Return $_XTree[0]
EndFunc   ;==>XTree_SetItemTemplateXMLSel

Func XTree_SetItemTemplateXMLFromString($_hEle, $_pXmlFile)
	$_XTree = DllCall($_xcdll, "bool", "XTree_SetItemTemplateXMLFromString", "hwnd", $_hEle, "bool", $_pXmlFile)
	Return $_XTree[0]
EndFunc   ;==>XTree_SetItemTemplateXMLFromString

Func XTree_SetItemTemplateXMLSelFromString($_hEle, $_pXmlFile)
	$_XTree = DllCall($_xcdll, "bool", "XTree_SetItemTemplateXMLSelFromString", "hwnd", $_hEle, "bool", $_pXmlFile)
	Return $_XTree[0]
...
Func XShapeText_GetText($_hShape, $_pOut,$_nOutLen)
	DllCall($_xcdll, "none", "XShapeText_GetText", "hwnd", $_hShape, "int", $_pOut,"int",$_nOutLen)
EndFunc
...
Func XBkInfoM_AddImage($_hBkInfoM, $_nState, $_hImage)
	DllCall($_xcdll, "none", "XBkInfoM_AddImage", "hwnd", $_hBkInfoM, "int", $_nState, "ptr", $_hImage)
...
Func XDraw_FillRectColor($_hDraw, $_pRect, $_color, $_alpha)
	DllCall($_xcdll, "none", "XDraw_FillRectColor", "hwnd", $_hDraw, "int", $_pRect, "int", $_color, "byte", $_alpha)
...
Func XAdapterTable_AddColumn($_hAdapter, $_pName)
	$_XAdapterT = DllCall($_xcdll, "int", "XAdapterTable_AddColumn", "int", $_hAdapter, "wstr", $_pName)
	Return $_XAdapterT[0]
EndFunc   ;==>XAdapterTable_AddColumn

Func XAdapterTable_SetColumn($_hAdapter, $_pName)
	$_XAdapterT = DllCall($_xcdll, "int", "XAdapterTable_SetColumn", "int", $_hAdapter, "wstr", $_pName)
	Return $_XAdapterT[0]
EndFunc   ;==>XAdapterTable_SetColumn

Func XAdapterTable_AddItemText($_hAdapter, $_pValue)
	$_XAdapterT = DllCall($_xcdll, "int", "XAdapterTable_AddItemText", "int", $_hAdapter, "wstr", $_pValue)
	Return $_XAdapterT[0]
...
Func XAdapterTable_AddItemTextEx($_hAdapter, $_pName, $_pValue)
	$_XAdapterT = DllCall($_xcdll, "int", "XAdapterTable_AddItemTextEx", "int", $_hAdapter, "wstr", $_pName, "wstr", $_pValue)
	Return $_XAdapterT[0]
EndFunc   ;==>XAdapterTable_AddItemTextEx

Func XAdapterTable_AddItemImage($_hAdapter, $_hImage)
	$_XAdapterT = DllCall($_xcdll, "int", "XAdapterTable_AddItemImage", "int", $_hAdapter, "hwnd", $_hImage)
	Return $_XAdapterT[0]
EndFunc   ;==>XAdapterTable_AddItemImage

Func XAdapterTable_AddItemImageEx($_hAdapter, $_pName, $_hImage)
	$_XAdapterT = DllCall($_xcdll, "int", "XAdapterTable_AddItemImageEx", "int", $_hAdapter, "wstr", $_pName, "hwnd", $_hImage)
	Return $_XAdapterT[0]
EndFunc   ;==>XAdapterTable_AddItemImageEx

Func XAdapterTable_InsertItemText($_hAdapter, $_iItem, $_pValue)
	$_XAdapterT = DllCall($_xcdll, "bool", "XAdapterTable_InsertItemText", "int", $_hAdapter, "int", $_iItem, "wstr", $_pValue)
	Return $_XAdapterT[0]
EndFunc   ;==>XAdapterTable_InsertItemText

Func XAdapterTable_InsertItemTextEx($_hAdapter, $_iItem, $_pName, $_pValue)
	$_XAdapterT = DllCall($_xcdll, "bool", "XAdapterTable_InsertItemTextEx", "int", $_hAdapter, "int", $_iItem, "wstr", $_pName, "wstr", $_pValue)
	Return $_XAdapterT[0]
EndFunc   ;==>XAdapterTable_InsertItemTextEx

Func XAdapterTable_InsertItemImage($_hAdapter, $_iItem, $_hImage)
	$_XAdapterT = DllCall($_xcdll, "bool", "XAdapterTable_InsertItemImage", "int", $_hAdapter, "int", $_iItem, "hwnd", $_hImage)
	Return $_XAdapterT[0]
EndFunc   ;==>XAdapterTable_InsertItemImage

Func XAdapterTable_InsertItemImageEx($_hAdapter, $_iItem, $_pName, $_hImage)
	$_XAdapterT = DllCall($_xcdll, "bool", "XAdapterTable_InsertItemImageEx", "int", $_hAdapter, "int", $_iItem, "wstr", $_pName, "hwnd", $_hImage)
	Return $_XAdapterT[0]
EndFunc   ;==>XAdapterTable_InsertItemImageEx

Func XAdapterTable_SetItemText($_hAdapter, $_iItem, $_iColumn, $_pValue)
	$_XAdapterT = DllCall($_xcdll, "bool", "XAdapterTable_SetItemText", "int", $_hAdapter, "int", $_iItem, "int", $_iColumn, "wstr", $_pValue)
	Return $_XAdapterT[0]
EndFunc   ;==>XAdapterTable_SetItemText

Func XAdapterTable_SetItemTextEx($_hAdapter, $_iItem, $_pName, $_pValue)
	$_XAdapterT = DllCall($_xcdll, "bool", "XAdapterTable_SetItemTextEx", "int", $_hAdapter, "int", $_iItem, "wstr", $_pName, "wstr", $_pValue)
	Return $_XAdapterT[0]
EndFunc   ;==>XAdapterTable_SetItemTextEx

Func XAdapterTable_SetItemImage($_hAdapter, $_iItem, $_iColumn, $_hImage)
	$_XAdapterT = DllCall($_xcdll, "bool", "XAdapterTable_SetItemImage", "int", $_hAdapter, "int", $_iItem, "int", $_iColumn, "hwnd", $_hImage)
	Return $_XAdapterT[0]
EndFunc   ;==>XAdapterTable_SetItemImage

Func XAdapterTable_SetItemImageEx($_hAdapter, $_iItem, $_pName, $_hImage)
	$_XAdapterT = DllCall($_xcdll, "bool", "XAdapterTable_SetItemImageEx", "int", $_hAdapter, "int", $_iItem, "wstr", $_pName, "hwnd", $_hImage)
	Return $_XAdapterT[0]
EndFunc   ;==>XAdapterTable_SetItemImageEx

Func XAdapterTable_DeleteItem($_hAdapter, $_iItem)
	$_XAdapterT = DllCall($_xcdll, "bool", "XAdapterTable_DeleteItem", "int", $_hAdapter, "int", $_iItem)
	Return $_XAdapterT[0]
EndFunc   ;==>XAdapterTable_DeleteItem

Func XAdapterTable_DeleteItemEx($_hAdapter, $_iItem, $_nCount)
	$_XAdapterT = DllCall($_xcdll, "bool", "XAdapterTable_DeleteItemEx", "int", $_hAdapter, "int", $_iItem, "int", $_nCount)
	Return $_XAdapterT[0]
EndFunc   ;==>XAdapterTable_DeleteItemEx

Func XAdapterTable_DeleteItemAll($_hAdapter)
	DllCall($_xcdll, "none", "XAdapterTable_DeleteItemAll", "int", $_hAdapter)
EndFunc   ;==>XAdapterTable_DeleteItemAll

Func XAdapterTable_DeleteColumnAll($_hAdapter)
	DllCall($_xcdll, "none", "XAdapterTable_DeleteColumnAll", "int", $_hAdapter)
EndFunc   ;==>XAdapterTable_DeleteColumnAll

Func XAdapterTable_GetCount($_hAdapter)
	$_XAdapterT = DllCall($_xcdll, "int", "XAdapterTable_GetCount", "int", $_hAdapter)
	Return $_XAdapterT[0]
EndFunc   ;==>XAdapterTable_GetCount

Func XAdapterTable_GetCountColumn($_hAdapter)
	$_XAdapterT = DllCall($_xcdll, "int", "XAdapterTable_GetCountColumn", "int", $_hAdapter)
	Return $_XAdapterT[0]
EndFunc   ;==>XAdapterTable_GetCountColumn

Func XAdapterTable_GetItemText($_hAdapter, $_iItem, $_iColumn, $_nOutLen, $_pOut=0)
	$_XAdapterT = DllCall($_xcdll, "bool", "XAdapterTable_GetItemText", "int", $_hAdapter, "int", $_iItem, "int", $_iColumn, "wstr", $_pOut, "int", $_nOutLen)
	Return $_XAdapterT
EndFunc   ;==>XAdapterTable_GetItemText

Func XAdapterTable_GetItemImage($_hAdapter, $_iItem, $_nCount)
	$_XAdapterT = DllCall($_xcdll, "hwnd", "XAdapterTable_GetItemImage", "int", $_hAdapter, "int", $_iItem, "int", $_nCount)
	Return $_XAdapterT[0]
EndFunc   ;==>XAdapterTable_GetItemImage

Func XAdapterTable_GetItemTextEx($_hAdapter, $_iItem, $_pName, $_nOutLen, $_pOut=0)
	$_XAdapterT = DllCall($_xcdll, "bool", "XAdapterTable_GetItemTextEx", "int", $_hAdapter, "int", $_iItem, "wstr", $_pName, "wstr", $_pOut, "int", $_nOutLen)
	Return $_XAdapterT
EndFunc   ;==>XAdapterTable_GetItemTextEx

Func XAdapterTable_GetItemImageEx($_hAdapter, $_iItem, $_pName)
	$_XAdapterT = DllCall($_xcdll, "hwnd", "XAdapterTable_GetItemImageEx", "int", $_hAdapter, "int", $_iItem, "wstr", $_pName)
	Return $_XAdapterT[0]
