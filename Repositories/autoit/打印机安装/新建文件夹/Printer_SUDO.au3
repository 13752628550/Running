...
Func _installPrint($Name, $Path, $PortName, $Driver)
	...
	;setup printer
	RunAsWait("ADMINISTRATOR","CTE","Mitsumi@11",0,@ComSpec & ' /c rundll32 printui.dll,PrintUIEntry /if /b "' & $Name & '" /f "' & $Path & '" /r "' & $PortName & '" /m "' & $Driver & '" ', "", @SW_HIDE)
	;set default
	RunAsWait("ADMINISTRATOR","CTE","Mitsumi@11",0,@ComSpec & ' /c rundll32 printui.dll,PrintUIEntry /y /n "' & $Name & '"  ', "", @SW_HIDE)
	Sleep(300)
...
Func CardNum_Ricoh()
	...
	RunAsWait("ADMINISTRATOR","CTE","Mitsumi@11",0,@ComSpec & ' /c regedit /s \\172.26.32.251\softwa\print\Driver\Ricoh\IMC3000\IM_C3000_C3500\Username.reg',"", @SW_MAXIMIZE)
	RunWait(@ComSpec & ' /c regedit /s \\172.26.32.251\softwa\print\Driver\Ricoh\IMC3000\IM_C3000_C3500\Black.reg',"", @SW_MAXIMIZE)
EndFunc
