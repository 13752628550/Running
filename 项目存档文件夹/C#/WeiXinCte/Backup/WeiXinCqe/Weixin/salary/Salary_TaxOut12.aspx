<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Salary_TaxOut12.aspx.cs" Inherits="WeiXinCqe.Salary_TaxOut12" %>
                                   ...
                                   <asp:Label ID="label_vsub" runat="server" Visible="False"></asp:Label>
                                         <asp:Label ID="label_vfrom" runat="server" Visible="False"></asp:Label>
                                          <asp:Label ID="label_vto" runat="server" Visible="False"></asp:Label>
                                                          <asp:Label ID="label_bonus_vlevel" runat="server" Visible="False"></asp:Label>
                             <asp:Label ID="label_bonus_vrate" runat="server" Visible="False"></asp:Label>
                                   <asp:Label ID="label_bonus_vsub" runat="server" Visible="False"></asp:Label>
                                         <asp:Label ID="label_bonus_vfrom" runat="server" Visible="False"></asp:Label>
                                          <asp:Label ID="label_bonus_vto" runat="server" Visible="False"></asp:Label>
    ...
    <div class="weui_cells weui_cells_form">
        ...
        <div class="weui_cell">
            <div class="weui_cell_hd">
                <asp:Label ID="label42" runat="server" class="weui_label" Font-Size="12pt">工资应税总额:</asp:Label></div>
        ...
        <div class="weui_cell">
            ...
            <div class="weui_cell_bd weui_cell_primary">
                ...
                <div class="weui_cell">
            <div class="weui_cell_hd">
                <asp:Label ID="label14" runat="server" class="weui_label" Font-Size="12pt">工资应税所得:</asp:Label></div>
            <div class="weui_cell_bd weui_cell_primary">
                <strong>
                ...
                <div class="weui_cell">
            <div class="weui_cell_hd">
                <asp:Label ID="label3" runat="server" class="weui_label" Font-Size="12pt">工资所得税:</asp:Label></div>
            <div class="weui_cell_bd weui_cell_primary">
                <strong>
                    <asp:Label ID="label6" runat="server" Text="0"></asp:Label>
                     ...
                     <div class="weui_cell">
            <div class="weui_cell_hd">
                <asp:Label ID="label1" runat="server" class="weui_label" Font-Size="12pt">奖金:</asp:Label></div>
            <div class="weui_cell_bd weui_cell_primary">
                <strong>
                 ...
                 <div class="weui_cell">
            <div class="weui_cell_hd">
                <asp:Label ID="label22" runat="server" class="weui_label" Font-Size="12pt">奖金应税所得:</asp:Label></div>
            <div class="weui_cell_bd weui_cell_primary">
                <strong>
                    <asp:Label ID="label23" runat="server" Text="0"></asp:Label>
                     ...
                     <div class="weui_cell">
            <div class="weui_cell_hd">
                <asp:Label ID="label18" runat="server" class="weui_label" Font-Size="12pt">奖金所得税:</asp:Label></div>
            <div class="weui_cell_bd weui_cell_primary">
                <strong>
                    <asp:Label ID="label19" runat="server" Text="0"></asp:Label>
                     ...
                     <div class="weui_cell">
            <div class="weui_cell_hd">
                <asp:Label ID="label20" runat="server" class="weui_label" Font-Size="12pt">个人所得税:</asp:Label></div>
            <div class="weui_cell_bd weui_cell_primary">
                <strong>
        ...
        <div class="weui_cells_title"  id="labeljiegudiv" runat="server">
            <strong>
            ...
            &nbsp;&nbsp;&nbsp;
                ...
                <div class="weui_cells_title">
            <strong>
                <asp:Label ID="Label26" runat="server"></asp:Label></strong>
            &nbsp;&nbsp;&nbsp;
        </div>
              <div class="weui_cells_title" id="label27div" runat="server">
            <strong>
                <asp:Label ID="Label27" runat="server"></asp:Label></strong>
            &nbsp;&nbsp;&nbsp;
        </div>
         <div class="weui_cells_title">
