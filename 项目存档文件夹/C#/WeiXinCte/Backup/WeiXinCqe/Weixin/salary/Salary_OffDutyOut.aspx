<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Salary_OffDutyOut.aspx.cs" Inherits="WeiXinCqe.Salary_OffDutyOut" %>
    ...
    <div class="weui_cells weui_cells_form">
        ...
        <div class="weui_cell">
            <div class="weui_cell_bd weui_cell_primary">
                <asp:Label ID="labelADJUSTMENT_PAY1" runat="server" class="weui_label" Font-Size="12pt">工资基数:</asp:Label></div>
            <div class="weui_cell_bd weui_cell_primary">
                <strong>
