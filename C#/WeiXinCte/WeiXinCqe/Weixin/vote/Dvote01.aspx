<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dvote01.aspx.cs" Inherits="WeiXinCqe.Weixin.vote.Dvote01" %>
    ...
    <div class="page">
        ...
        <div class="weui_media_box weui_media_text" id="link26">
            <ul class="weui_media_info">
                <li class="weui_media_info_meta">&nbsp;&nbsp;&nbsp;&nbsp;截止时间:<asp:Label ID="Labellimittime" runat="server" Text="2021-3-17 10:00"></asp:Label></li>
            </ul>
        </div>
        ...
        <div class="page__bd">
            <form id="form1" runat="server">
                   ...
                   <div class="weui-cells__title">是否自愿接种新冠防疫疫苗?</div>
