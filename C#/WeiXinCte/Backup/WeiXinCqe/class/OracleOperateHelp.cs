...
namespace WeiXinCqe
{
    ...
    {
        public static readonly string ConnectionStringLocalTransaction = "Data Source=" + ConfigurationManager.AppSettings["DataSorce"] + ";Persist Security Info=True;User ID=" + ConfigurationManager.AppSettings["DataUser"] + ";Password=" + ConfigurationManager.AppSettings["DataPwd"] + ";Unicode=True";
