<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Salary_HBonusPay12.aspx.cs" Inherits="WeiXinCqe.Salary_HBonusPay12" %>
    ...
    <div class="weui_cells weui_cells_form">
        ...
        <div class="weui_cell">
            ...
            <div class="weui_cell_bd weui_cell_primary">
                ...
                <div class="weui_cell">
            <div class="weui_cell_hd">
                <asp:Label ID="label22" runat="server" class="weui_label" Font-Size="12pt">入社日期:</asp:Label></div>
            <div class="weui_cell_bd weui_cell_primary">
                <strong>
                    <asp:Label ID="label_DATE_IN" runat="server"></asp:Label>
                </strong>
            </div>
        </div>
                <div class="weui_cell">
            <div class="weui_cell_hd">
                <asp:Label ID="label26" runat="server" class="weui_label" Font-Size="12pt">转正天数:</asp:Label></div>
            <div class="weui_cell_bd weui_cell_primary">
                <strong>
                    <asp:Label ID="label_DATE_TEST" runat="server"></asp:Label>
                </strong>
            </div>
        </div>
        <div class="weui_cell">
        ...
        <div class="weui_cell">
            ...
            <div class="weui_cell_bd weui_cell_primary">
             ...
             <div class="weui_cell">
            <div class="weui_cell_hd"  >
                <asp:Label ID="label25" runat="server" class="weui_label" Font-Size="12pt">实际出勤率:</asp:Label></div>
            <div class="weui_cell_bd weui_cell_primary">
                <strong>
        ...
        <div class="weui_cell">
            ...
            <div class="weui_cell_bd weui_cell_primary">
                ...
                <div class="weui_cell">
            <div class="weui_cell_hd">
                <asp:Label ID="label20" runat="server" class="weui_label" Font-Size="12pt">期间欠格率:</asp:Label></div>
            <div class="weui_cell_bd weui_cell_primary">
                <strong>
                    <asp:Label ID="label_OFF_FACTOR_SHOW" runat="server"></asp:Label>
                </strong>
            </div>
        </div>
        <div class="weui_cell">
        ...
        <div class="weui_cell" runat="server" id="v_on_duty" visible="false">
            <div class="weui_cell_hd">
                <asp:Label ID="label21" runat="server" class="weui_label" Font-Size="12pt">实际出勤天数:</asp:Label></div>
            <div class="weui_cell_bd weui_cell_primary">
                <strong>
        ...
        <div class="weui_cell"  runat="server" id="v_sum_duty" visible="false">
            <div class="weui_cell_hd">
                <asp:Label ID="label23" runat="server" class="weui_label" Font-Size="12pt" 
                    Width="125px">实际应出勤天数:</asp:Label></div>
            <div class="weui_cell_bd weui_cell_primary">
                <strong>
        ...
        <div class="weui_cells_title" id="div2" runat="server" visible="true">
            ...
            <strong>
                <asp:Label ID="Label18" runat="server">     </asp:Label></strong>
                     ...
                     <div class="weui_cells_title" id="div10" runat="server" visible="false">
            <strong>
                <asp:Label ID="Label24" runat="server">     </asp:Label></strong>
        </div>
            ...
            <strong>
                ...
                <Columns>          
                    <asp:BoundField DataField="BEGIN_DATE" HeaderText="开始日期">
                        ...
                        <ItemStyle HorizontalAlign="Center" />
                              ...
                              <asp:BoundField DataField="OFF_FACTOR" HeaderText="欠格率">
                        <HeaderStyle HorizontalAlign="Center" />
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:BoundField>
                </Columns>
               ...
               <div class="weui_cells_title">
                       <asp:GridView ID="GridView4" runat="server" AutoGenerateColumns="False" 
                           Width="100%" ShowFooter="true" onrowdatabound="GridView4_RowDataBound">
                <Columns>          
                    <asp:BoundField DataField="YYYYMM" HeaderText="月份">
                        <HeaderStyle HorizontalAlign="Center" />
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:BoundField>
                               <asp:BoundField DataField="V_ON_DUTY" HeaderText="实际出勤">
                        <HeaderStyle HorizontalAlign="Center" />
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:BoundField>
                              <asp:BoundField DataField="V_SUM_DUTY" HeaderText="实际应出勤">
                        <HeaderStyle HorizontalAlign="Center" />
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:BoundField>
                </Columns>
        ...
        <div class="weui_cells_title" id="div1" runat="server" visible="true">
            <strong>
                <asp:Label ID="Label11" runat="server">特别说明: 大过或小过处分的自动修改考课为C  &nbsp;&nbsp;&nbsp;&nbsp;   出勤率达不到5/6的职工,最高只能评为B</asp:Label></strong>
            &nbsp;&nbsp;&nbsp;
        </div>
                <div class="weui_cells_title" id="div11" runat="server" visible="false">
            <strong>
                <asp:Label ID="Label28" runat="server">特别说明: 实际应出勤天数=出勤+实际欠勤+公假+产假+工伤假+病假+一时归休  &nbsp;&nbsp;&nbsp;   &nbsp;        实际出勤天数=出勤+公假+工伤假+一时归休         &nbsp;  &nbsp;&nbsp;&nbsp; 实际出勤和应出勤都指在奖金计算区间内的合同工记录，不含派遣期间记录</asp:Label></strong>
            &nbsp;&nbsp;&nbsp;
        </div>
    </div>
    </form>
