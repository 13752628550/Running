<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Salary_AdjustmentPay.aspx.cs"
    Inherits="WeiXinCqe.Salary_AdjustmentPay" %>
...
<body>
    ...
    <div class="weui_cells weui_cells_form">
        ...
        <div class="weui_cells_title" id="P" runat="server">
            <strong>
                <asp:Label ID="Label1" runat="server" Style="color: #33CC33">说明:公积金补助（派遣工)为固定值，派遣工出勤率超过50%的有全额，否则为0，其他调整由人事导入</asp:Label></strong>
            &nbsp;&nbsp;&nbsp;
            <div class="weui_cell">
