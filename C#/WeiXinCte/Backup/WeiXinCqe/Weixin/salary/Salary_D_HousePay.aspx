<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Salary_D_HousePay.aspx.cs" Inherits="WeiXinCqe.Weixin.salary.Salary_D_HousePay" %>
...
<body>
    ...
    <div class="weui_cells weui_cells_form">
        ...
        <div class="weui_cells_title">
            <strong>
                <asp:Label ID="Label1" runat="server" Style="color: #33CC33">说明:住宅补助最高不能超过补助标准</asp:Label></strong>
            &nbsp;&nbsp;&nbsp;
        </div>
    </div>
    </form>
