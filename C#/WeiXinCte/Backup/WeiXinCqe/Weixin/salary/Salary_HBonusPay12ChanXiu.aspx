<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Salary_HBonusPay12ChanXiu.aspx.cs" Inherits="WeiXinCqe.Salary_HBonusPay12ChanXiu" %>
...
<body>
    ...
    <div class="weui_cells weui_cells_form">
        ...
        <div class="weui_cell">
            <div class="weui_cell_hd">
                <asp:Label ID="label7" runat="server" class="weui_label" Font-Size="12pt">奖金支付系数:</asp:Label></div>
            <div class="weui_cell_bd weui_cell_primary">
                <strong>
                    <asp:Label ID="label_BONUS_FACTOR" runat="server"></asp:Label>
                </strong>
            </div>
        </div>
        <div class="weui_cell">
