<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Salary_PostPay.aspx.cs" Inherits="WeiXinCqe.Salary_PostPay" %>
...
<body>
    ...
    <div class="weui_cells weui_cells_form">
        <div class="weui_cells_title">
            <strong>
                <asp:Label ID="labled" runat="server" Text="行政补贴明细"></asp:Label></strong> &nbsp;&nbsp;&nbsp;
        ...
        <div class="weui_cell">
            <div class="weui_cell_hd">
                <asp:Label ID="label7" runat="server" class="weui_label" Font-Size="12pt">行政职务:</asp:Label></div>
            <div class="weui_cell_bd weui_cell_primary">
                <strong>
        ...
        <div class="weui_cell">
            <div class="weui_cell_hd">
                <asp:Label ID="label8" runat="server" class="weui_label" Font-Size="12pt">行政补贴标准:</asp:Label></div>
            <div class="weui_cell_bd weui_cell_primary">
                <strong>
        ...
        <div class="weui_cell">
            <div class="weui_cell_hd">
                <asp:Label ID="label4" runat="server" class="weui_label" Font-Size="12pt">实发行政补贴:</asp:Label></div>
            <div class="weui_cell_bd weui_cell_primary">
                <strong>
