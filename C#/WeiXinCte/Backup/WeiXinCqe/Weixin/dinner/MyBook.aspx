<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyBook.aspx.cs" Inherits="WeiXinCqe.MyBook" %>
...
<body>
    ...
    <div class="weui_cells_title"><strong>出勤日:</strong><asp:TextBox ID="TextBox1" 
        ...
        &nbsp;&nbsp;<a class="weui_panel_ft" 
            href="MyDinner.aspx"><strong>我的预约</strong></a></div>
