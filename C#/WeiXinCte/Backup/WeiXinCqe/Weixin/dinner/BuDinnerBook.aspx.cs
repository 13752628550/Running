...
{
    public partial class BuDinnerBook : System.Web.UI.Page
    {
        ...
        protected void Button5_Click(object sender, EventArgs e)
        {
            using (OracleConnection conn = new OracleConnection(OracleOperateHelp.ConnectionStringLocalTransaction))
            {
                ...
                try
                {
                    ...
                    if(TextBox3.Text.ToString().Trim()=="1")
                    {
                       sql=" UPDATE CS_STAFF_DINNER_NEW_NEW SET  FLAG='1' , DINNER_SIGN=WORK_DAY+0.33,DINNER_TERMINAL='P00024186'  WHERE STAFFID ='"+TextBox1.Text.ToString().Trim()+"'  AND WORK_DAY=TO_DATE('"+TextBox2.Text.ToString().Trim()+"','YYYY-MM-DD')  AND FLAG IN ('0')   AND ISLOCK='1' AND DINNER_TYPE ='1'";
                    }

                                if(TextBox3.Text.ToString().Trim()=="2")
                    {
                       sql=" UPDATE CS_STAFF_DINNER_NEW_NEW SET  FLAG='1' , DINNER_SIGN=WORK_DAY+0.51,DINNER_TERMINAL='P00024186'  WHERE STAFFID ='"+TextBox1.Text.ToString().Trim()+"'  AND WORK_DAY=TO_DATE('"+TextBox2.Text.ToString().Trim()+"','YYYY-MM-DD')  AND FLAG IN ('0')   AND ISLOCK='1' AND DINNER_TYPE ='2'";
                    }

                                if(TextBox3.Text.ToString().Trim()=="3")
                    {
                       sql=" UPDATE CS_STAFF_DINNER_NEW_NEW SET  FLAG='1' , DINNER_SIGN=WORK_DAY+0.73,DINNER_TERMINAL='P00024186'  WHERE STAFFID ='"+TextBox1.Text.ToString().Trim()+"' AND WORK_DAY=TO_DATE('"+TextBox2.Text.ToString().Trim()+"','YYYY-MM-DD')  AND FLAG IN ('0')   AND ISLOCK='1' AND DINNER_TYPE ='3'";
                    }
                    cmd.Transaction = tran;
                    cmd.CommandType = CommandType.Text;
                    cmd.CommandText = sql;
                    ...
                    int result = cmd.ExecuteNonQuery();
                    tran.Commit();
                    Page.ClientScript.RegisterClientScriptBlock(this.GetType(), "", "<script languange=javascript>alert('就餐成功。') ;</script>");

                }
                catch 
                {
                    Page.ClientScript.RegisterClientScriptBlock(this.GetType(), "", "<script languange=javascript>alert('失败。') ;</script>");
            ...
            using (OracleConnection conn = new OracleConnection(OracleOperateHelp.ConnectionStringLocalTransaction))
            {
                ...
                try
                {
                    string sql = "";
                        ...
                        sql = " UPDATE CS_STAFF_DINNER_NEW_NEW SET  FLAG='0' , DINNER_SIGN=null,DINNER_TERMINAL=null WHERE STAFFID ='" + TextBox1.Text.ToString().Trim() + "'  AND WORK_DAY=TO_DATE('" + TextBox2.Text.ToString().Trim() + "','YYYY-MM-DD')  AND FLAG IN ('1')   AND ISLOCK='1' AND DINNER_TYPE ='"+TextBox3.Text.ToString().Trim()+"'";
                    ...
                    int result = cmd.ExecuteNonQuery();
                    tran.Commit();
                    Page.ClientScript.RegisterClientScriptBlock(this.GetType(), "", "<script languange=javascript>alert('取消成功。') ;</script>");
