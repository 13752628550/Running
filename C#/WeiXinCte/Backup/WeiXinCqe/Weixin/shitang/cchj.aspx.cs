...
namespace WeiXinCqe
{
    public partial class cchj : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                if (Request.Cookies["fromsource"] == null)
                {
                    ...
                    Response.Redirect("https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxba0960da7da41224&redirect_uri=http://wechat.fortest.ren/Weixin/authority/getSource.aspx&response_type=code&scope=snsapi_base&state=shitang1#wechat_redirect");
                }
                else
                {
